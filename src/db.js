...
async function init() {
  ...
  await pool.query("ALTER TABLE demandas_avulsas ADD COLUMN IF NOT EXISTS turno TEXT DEFAULT 'diurno';");
  ...
  await pool.query('ALTER TABLE chamados ADD COLUMN IF NOT EXISTS valor_fixo NUMERIC DEFAULT 0;');
